// class GmailVerificationResponseModel {
//   final int code;
//   final String message;
//   final LoginData data;
//
//   GmailVerificationResponseModel({
//     required this.code,
//     required this.message,
//     required this.data,
//   });
//
//   factory GmailVerificationResponseModel.fromJson(Map<String, dynamic> json) {
//     return GmailVerificationResponseModel(
//       code: json['code'] ?? 0,
