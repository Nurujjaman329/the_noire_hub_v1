...
class ServiceDealsPromosScreen extends StatelessWidget {
  const ServiceDealsPromosScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(title: "Deals & Promos",showBackButton: true,),
      body: Padding(
