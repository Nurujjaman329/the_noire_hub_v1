...
import 'package:the_noire_hub_v1/features/customer/customerBookingList/presentation/screen/widget/booking_card.dart';
...
class CustomerBookingsList extends StatelessWidget {
                ...
                return RefreshIndicator(
                  ...
                  child: displayList.isEmpty
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return BookingCard(booking: displayList[index - 1], tabStatus: selectedTab);
                    },
                  ),
                );
              }),
  ...
  Widget _buildStatusTabs(CustomerBookingListController controller) {
